...
//Task with * 1
let yourNu1 = prompt('Введите число 1 из 3:', 'Name')
let yourNu2 = prompt('Введите число 2 из 3:', 'Two Name')
...
//yourAge -> translate from String to Number
alert(`Ваше первое число +10: ${res1}, Ваше второе число +10: ${res2}, Ваше третье число +10: ${res3}`)
